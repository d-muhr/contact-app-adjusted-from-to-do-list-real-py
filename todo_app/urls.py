...
urlpatterns = [
    ...
    path("contact_list/<int:contact_id>/", views.ContactListView.as_view(), name="list"),
    ...
    path(
        "contact_list/<int:contact_id>/contact/add/",
        views.ContactCreate.as_view(),
        name="item-add",
    ),
    path(
        "contact_list/<int:contact_id>/contact/<int:pk>/",
        views.ContactUpdate.as_view(),
        name="item-update",
    ),
    path(
        "contact_list/<int:contact_id>/contact/<int:pk>/delete/",
