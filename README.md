# contact app adjusted from to do list real py
  I adjusted the to do list app by Real-Python.com to make it a contact app. This was a training project which I did after having done the official django-tutorial in order to get to know CRUD and Django in general better to enable me to make an entirely own project in Django soon. 
